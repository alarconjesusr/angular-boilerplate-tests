...
@Component({
  ...
  template: `
    <div class="p-6 flex flex-col items-center justify-between h-full">
      <div class="bg-black w-10 h-8 rounded-full"></div>
      ...
      <div class="flex flex-col gap-12">
        <button class="flex flex-col gap-2 items-center justify-center">
          ...
          <div class="text-xs">All chats</div>
        </button>
        <button class="flex flex-col gap-2 items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="bg-black w-10 h-8 rounded-full text-white flex items-center justify-center">
        P
      </div>
    </div>
  `,
